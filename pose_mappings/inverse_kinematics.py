...
left_arm_chain = Chain(name="left_arm", links=[
    ...
    URDFLink(name="left_elbow_pitch", bounds=(-1.5707963, 1.5707963), translation_vector=[0, 0.1, 0], rotation=[1, 0, 0]),
])
...
right_arm_chain = Chain(name="right_arm", links=[
    ...
    URDFLink(name="right_elbow_pitch", bounds=(-1.5707963, 1.5707963), translation_vector=[0, -0.1, 0], rotation=[1, 0, 0]),
])
